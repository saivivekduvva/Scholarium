          ...
          >
            ...
            <div style={{ textAlign: 'center', maxWidth: '250px' }}>
              <div style={{ 
                ...
                overflow: 'hidden',
                margin: '0 auto 20px',
                boxShadow: '8px 8px 0px #4F6EF7'
              }}>
                <img src="/founder_placeholder.png" alt="Founder" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            ...
            <div style={{ textAlign: 'center', maxWidth: '250px' }}>
              <div style={{ 
                ...
                overflow: 'hidden',
                margin: '0 auto 20px',
                boxShadow: '8px 8px 0px #F4E87C'
              }}>
                <img src="/founder_placeholder.png" alt="Co-Founder" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
